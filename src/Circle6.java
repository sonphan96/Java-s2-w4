...
public class Circle6 {
     ...
     * @param y the initial y value
     */
    public Circle6(double radius, double x, double y) {
        this.radius = radius;
        this.x = x;
        this.y = y;
    }
     ...
     */
    public boolean isInside(Circle6 other) {
     ...
     */
    private double distance(Circle6 other) {
    ...
    public String toString() {
        return "Circle6: radius " + radius + ", location (" + x + "," + y + ")";
    }
}
